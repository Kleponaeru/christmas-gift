...
const gifts: Gift[] = [
  {
    ...
    emoji: "🎁",
    title: "First Date",
    message: "I still remember the butterflies I felt when we first met. Every moment with you since has been a gift.",
  },
  {
    id: 2,
    emoji: "🌹",
    title: "Your Smile",
    message: "You have the most beautiful smile that lights up my entire world. Thank you for sharing it with me.",
  },
  {
    id: 3,
    emoji: "💝",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {gifts.map((gift, index) => (
          <motion.div
            ...
            onClick={() => setOpenedGift(openedGift === gift.id ? null : gift.id)}
          ...
          >
            ...
            >
              ...
              {openedGift === gift.id ? (
                ...
                >
                  <h3 className="text-2xl font-serif font-bold mb-4">{gift.title}</h3>
